...
//		      new Chart();
	    ...
	    public JFreeChart getChart(ArrayList<ExpireChart_DTO> elist) {
	     ...
	     // DefaultCategoryDataset dataset12 = new DefaultCategoryDataset();         // bar chart 2
	        ...
	        int[] ii = new int[12];
	        int i = 0;
	        for (ExpireChart_DTO expireChart_DTO : elist) {
				System.out.println(expireChart_DTO.getMonth());
				ii[i] = (int) expireChart_DTO.getExpire_amount();
				System.out.println(expireChart_DTO.getExpire_amount());
				i++;
			}
	        
	        
	        dataset1.addValue(ii[0], "지출액", "1월");
	        
	        dataset1.addValue(ii[1], "지출액", "2월");
	       
	        dataset1.addValue(ii[2], "지출액", "3월");
//
//	        dataset1.addValue(getExpire_amount(2), "지출액", "4월");
//
//	        dataset1.addValue(getExpire_amount(2), "지출액", "5월");
